...
<body>
    <form action="connect.php" method="post" align="center">
        <div class="title">
        ...
        <div class="info">
            ...
            <input type="number" placeholder="Trip Number" name="TripNumber"><br><br>
            <input type="tel" id="tel" name="PhoneNumber" placeholder="Phone Number" /><br>
            <input type="text" name="TicketID" placeholder="Ticket ID"><br><br>
         ...
         <input type="text" name="destinationChoice" placeholder="Destination bus stop"><br><br>
